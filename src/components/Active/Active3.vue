    ...
    <div class="banner">
      <div class="box">
        <div>
          ...
          <p style="font-size:.4rem;font-weigth:600;margin:.18rem 0 .2rem 0;">新手上云 一律<span class="pink-text">免费</span>
          </p>
          <div>
    ...
    methods: {
      setInit (v) {
        ...
        this.time = [10, 12, 15, 17].map((item, index) => {
          return {
            time: item,
            timestamp: date.setHours(item, 0, 0, 0),
            remainder: v[1].data.data[index],
            selectedConfig: 31,
