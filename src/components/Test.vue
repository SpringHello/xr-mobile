<template>
  <div>
    ...
    <div class="newscenter">
      ...
      <div id="news"
           style="padding:.3rem 0;border-top: 1px solid #ccc;border-bottom: 1px solid #ccc ;height: 8rem;overflow: auto">
        <swipeout id="douct">
...
<script>
  ...
  export default{
    ...
    mounted(){
      $('#news').scroll(() => {
        console.log('scroll')
        var scrollTop = $('#news').scrollTop();
        var scrollHeight = $('#douct').height();
        var windowHeight = $('#news').height();
