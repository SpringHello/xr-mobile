  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        renewal: '',
        controls: [
          {img: require('../assets/img/console/yunfuwu.png'), title: '云服务器', url: 'bhost'},
          {img: require('../assets/img/console/yunyipan.png'), title: '云硬盘', url: 'bdisk'},
          {img: require('../assets/img/console/tanip.png'), title: '弹性IP', url: 'belasticip'},
          {img: require('../assets/img/console/fuzaijunh.png'), title: '负载均衡', url: 'bbalance'},
