<template>
  <div style="background:rgba(255,255,255,1);height: 100%;min-height: 560px;" id="register">
    <x-header>注册
    ...
    <div v-show="currentStep==2">
      ...
      <form class="sign-form">
        ...
        <div class="checks">
          <check-icon :value.sync="demo">我已阅读并同意
            <span class="checkColor" @click="currentStep=3">《新睿云用户协议》</span>
          </check-icon>
        </div>
      </form>
    </div>
    <div v-show="currentStep==3">
      <div class="rulesContent">
        <p style="text-align:center"><strong style="font-size: .3rem">新睿云业务服务协议</strong></p>
        <p style="margin-top: .3rem"><strong>本网站（www.xrcloud.net）所提供服务是由北京允睿讯通科技有限公司新睿云向本网站注册用户提供的云计算产品和相关服务，
          详见本网站相关产品及服务介绍。本协议由您和北京允睿讯通科技有限公司签订。</strong></p>
        <p style="margin-top: .2rem; text-indent:0em"><strong>第一条 总则</strong></p>
        ...
        <p style="margin-top: .2rem;text-indent:0em"><strong>第二条 服务内容</strong></p>
        ...
        <p style="margin-top: .2rem;text-indent:0em"><strong>第三条 费用及支付</strong></p>
        ...
        <p style="margin-top: .2rem;text-indent:0em"><strong>第四条 资质保证及使用规则</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第五条 数据私密性、数据知情权和数据可审查性</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第六条 甲方的权利和义务</strong></p>
        ...
        <p>6.5对于甲方使用云业务服务过程中所涉自身信息和资料、数据（包括但不限于商业机密等）、最终用户及其他相关主体的信息和资料、数据等，甲方负责保密，并自行承担由此产
          生的一切后果和责任。</p>
        <p style="margin-top: .2rem; text-indent:0em"><strong>第七条 乙方权利和义务</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第八条 服务的变更、中断或终止</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第九条 违约责任</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第十条 保密</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第十一条 不可抗力及免责</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第十二条 法律适用和争议解决</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>第十三条 协议生效及其他</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em">本协议附件为：</p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>附件一  《云业务服务使用责任书》</strong></p>
        <p style="text-indent:0em"><strong>云业务服务使用责任书</strong></p>
        <p style="margin-top: .2rem; text-indent:0em">通过使用云业务服务接入电信公网的用户（“用户”）必须认真阅读《云业务服务使用责任书》（“《责任书》”），并
          自觉遵守《责任书》的各项规定。</p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>附件二  《网络信息安全承诺书》</strong></p>
        ...
        <p style="margin-top: .2rem; text-indent:0em"><strong>附件三  《新睿云云主机服务等级协议》</strong></p>
        ...
        <div style="text-align: center;margin-top: .25rem">
          <button @click="allowRules">阅读并同意</button>
        </div>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      register(){
        ...
        if (!this.demo) {
          this.$vux.toast.text('请阅读并同意<br>《新睿云用户协议》', 'middle')
          return
        }
        let params = {
          questionId: '4',
